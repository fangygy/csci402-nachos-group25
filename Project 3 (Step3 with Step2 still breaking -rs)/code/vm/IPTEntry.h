...
//	physical page # -> virtual page #, used for managing
...
// The following class defines an entry in a translation table -- used
// in the inverted page table (IPT).  Each entry defines a mapping from one 
...
// Different from TranslationEntry in that this has a SpaceId value
