...
class Lock {
  public:
    ...
    void Acquire(Lock* lockLock); //THIS IS DISGUSTING.  PLEASE REFER TO WAIT FOR OUR REASONS WHY
...
class Condition {
  public:
    ...
    void Wait(Lock *conditionLock); 	// these are the 3 operations on 
					...
					// *atomic* in Wait()
    void Wait(Lock *conditionLock, Lock *condLock);	//DON'T LOOK AT THIS, PLEASE!  
    							//We know it's not good, but seriously, 
    							//we have no idea how we could live without it.  
    							//It fixes some terrible race condition that we have no 
    							//idea of how to fix without doing something ridiculously
    							//terrible like this
