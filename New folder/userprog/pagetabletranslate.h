...
#ifndef PAGE_TABLE_TLB_H
#define PAGE_TABLE_TLB_H

#include "copyright.h"
#include "utility.h"

    enum pageLocationEnum{ // location of page table
    	IN_EXECUTABLE,
	    IN_SWAP_FILE,
    	NEITHER,
	}; 
...
class PageTableTranslationEntry {
  public:
	...
	int diskLocation;  // location of entry on disk
	
	int swapFileLocation; // location of entry in swapFile
};
